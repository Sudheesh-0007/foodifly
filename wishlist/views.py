...
def add_to_wishlist(request):
    ...
    if request.method == "POST":
        ...
        product =  get_object_or_404(Product,id=product_id,is_deleted=False,isBlocked=False,isActive=True)
        ...
        variant = Variant.objects.filter(id=variant_id, product=product, is_active=True).first()
